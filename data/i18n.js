export const ui = {
  it: {
    ...
    home: {
      ...
      chiSiamoTitle: "Una comunità di professionisti/professioniste per ogni genitorialità",
      ...
      chiSiamoP2: "Ci siamo incontrati lavorando in questo campo e abbiamo deciso di costruire qualcosa insieme: un punto di riferimento integrato per le coppie che vivono la gravidanza, il parto e il post-partum, sia quando tutto va bene, sia quando qualcosa è più difficile del previsto.",
      chiSiamoP3: "La nostra visione è semplice: ogni coppia merita supporto professionale, umano e privo di giudizio. Nessuna deve affrontare questo percorso da solo.",
  ...
  en: {
    ...
    home: {
      heroTag: "Parenting Care Professionals",
      heroTitle: "Sostegno alla Genitorialità",
      ...
      chiSiamoTitle: "A community of professionals for every kind of parenting",
      chiSiamoP1: "We are a group of professionals with different backgrounds and specialties — perinatal psychologists, gynecologists, midwives, physiotherapists, nutritionists, breastfeeding consultants, tax and welfare consultants for parenting — united by a deep interest in parenting in all its dimensions.",
      chiSiamoP2: "We met while working in this field and decided to build something together: an integrated point of reference for couples experiencing pregnancy, childbirth, and postpartum, whether everything is going well or something is more difficult than expected.",
      chiSiamoP3: "Our vision is simple: every couple deserves professional, human, and non-judgmental support. No one should have to face this journey alone.",
      ...
      features: [
        ...
        { title: "Support groups", desc: "Themed groups for expectant couples, new parents going through difficult situations, or those who want to approach their new role with greater awareness." },
